...
run_prod:
	docker run --restart always --network host --name retrieval_plugin --env-file /etc/aii/retrieval_plugin.env -d dextr/aii_admin_backend:retrieval_plugin_test3
build:
