...
class DataStore(ABC):
    async def upsert(
        self, documents: List[Document], chunk_token_size: Optional[int] = None, chunk_overlap: Optional[int] = None
    ) -> List[str]:
        """
        ...
        chunks = get_document_chunks(documents, chunk_token_size, chunk_overlap)
